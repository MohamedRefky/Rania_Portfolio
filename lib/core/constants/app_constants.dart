...
class AppConstants {
  ...
  static String get devTitle =>
      _info['title'] ?? 'Architectural Engineer | BIM Specialist';
  ...
  static String get devImagePath =>
      _info['image'] ?? 'assets/images/Rania_Image.jpeg';
  static String get devCvPath => _info['cv'] ?? '';

  // Social Links
  static String get githubUrl => _info['github'] ?? '';
  static String get linkedinUrl =>
      _info['linkedin'] ??
      'https://www.linkedin.com/in/rania-abdelbary-718b85342';
